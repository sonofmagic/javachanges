...
public final class ReleaseEnvCatalog {
    public static final List<EnvEntry> COMMON_VARIABLES = Arrays.asList(
        ...
        new EnvEntry("MAVEN_CENTRAL_USERNAME", true, false),
        new EnvEntry("MAVEN_CENTRAL_PASSWORD", true, false),
    ...
    public static final List<EnvEntry> GITLAB_VARIABLES = Arrays.asList(
        ...
        new EnvEntry("MAVEN_CENTRAL_USERNAME", true, true),
        new EnvEntry("MAVEN_CENTRAL_PASSWORD", true, true),
