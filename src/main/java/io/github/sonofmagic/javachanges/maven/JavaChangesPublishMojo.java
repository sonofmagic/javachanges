...
@Mojo(name = "publish", defaultPhase = LifecyclePhase.NONE, threadSafe = true, requiresProject = true)
public final class JavaChangesPublishMojo extends AbstractJavaChangesMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        executeStructuredGoal("publish", "publish", args.toArray(new String[0]));
    }
}
