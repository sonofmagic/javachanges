...
mvn io.github.sonofmagic:javachanges:1.11.0-SNAPSHOT:setup
mvn io.github.sonofmagic:javachanges:1.11.0-SNAPSHOT:init -Djavachanges.config=true
mvn io.github.sonofmagic:javachanges:1.11.0-SNAPSHOT:next
mvn io.github.sonofmagic:javachanges:1.11.0-SNAPSHOT:modules
mvn io.github.sonofmagic:javachanges:1.11.0-SNAPSHOT:status
...
mvn io.github.sonofmagic:javachanges:1.11.0-SNAPSHOT:write-settings -Djavachanges.settingsMode=release
...
- `snapshot:install` 把当前 `1.11.0-SNAPSHOT` 安装到本地 Maven 仓库
