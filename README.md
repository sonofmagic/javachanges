...
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:setup
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:init -Djavachanges.config=true
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:next
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:modules
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:status
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:validate
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:plan -Djavachanges.apply=true
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:add -Djavachanges.summary="add release notes command" -Djavachanges.release=minor
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:write-settings -Djavachanges.settingsMode=release
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:doctor-publish
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:manifest-field -Djavachanges.field=releaseVersion
mvn io.github.sonofmagic:javachanges:1.13.0-SNAPSHOT:release-notes -Djavachanges.tag=v1.2.3 -Djavachanges.output=target/release-notes.md
```
...
- `snapshot:install` installs the current `1.13.0-SNAPSHOT` into local Maven
