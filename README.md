...
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:setup
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:init -Djavachanges.config=true
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:next
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:modules
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:status
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:validate
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:plan -Djavachanges.apply=true
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:add -Djavachanges.summary="add release notes command" -Djavachanges.release=minor
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:write-settings -Djavachanges.settingsMode=release
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:doctor-publish
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:manifest-field -Djavachanges.field=releaseVersion
mvn io.github.sonofmagic:javachanges:1.12.3-SNAPSHOT:release-notes -Djavachanges.tag=v1.2.3 -Djavachanges.output=target/release-notes.md
```
...
- `snapshot:install` installs the current `1.12.3-SNAPSHOT` into local Maven
